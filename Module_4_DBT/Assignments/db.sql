...
select * from employees where LAST_NAME = 'smith' and FIRST_NAME='william';

-- 1.update job as Software Developer whose name is Smith

update employees
set job_id = 'Software Developer'
where employee_id = 171;

-- 2.update salary and commission_pact whose empid is 157

select * from employees where employee_id = 157;

update employees
set salary = 10000,commission_pct = 0.45
...
select *,salary*12 as 'anualSalary' from employees;

-- update comm to 100 whose commission is null.

update employees
set commission_pct= 100
where commission_pct='null';

-- delete department whose deptno is 40.

select * from employees where department_id = 40;

delete from employees where department_id = 40;

-- delete all employees who is hired on '1987-09-30'

select * from employees;

select * from employees where hire_date ='1987-09-30';

delete from employees where hire_date ='1987-09-30';

-- delete all employees whose deptno is 10.
